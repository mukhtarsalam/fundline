    ...
    <div class="container-fluid home-body">
        <div class="row home-body">
            ...
            <div class="col-lg-12 latest-post-section">
                ...
                <a href='allposts.php'> <button type='button' class='btn btn-primary view-button'> View All</button></a>
            </div>
        </div>
    </div>
</section>
