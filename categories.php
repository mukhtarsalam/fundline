                ...
                <div class="row latest-uploads">
                    ...
                    if (mysqli_num_rows($results) < 1) {
                        echo "<div class='col-lg-12'>
                                <p>No Business Plan uploaded yet in $categories category!</p>
                                <p>Be the first to uplaod a business plan $categories category, click <a href='create_listing.php'>here</a> to upload a business plan</p>
                                </div>	";
                    } else {
